...
class CBN(nn.Module):
    def __init__(self, channel, batch_size):
        super(CBN, self).__init__()
        self.channel = channel
        # self.attributes = attributes
        self.batch_size = batch_size
        self.betas = nn.Parameter(torch.zeros(self.batch_size, self.channel))
        self.gammas = nn.Parameter(torch.ones(self.batch_size, self.channel))
        # self.batch_size = batch_size
        # self.channel = channel
        # self.height = height
        # self.width = width
