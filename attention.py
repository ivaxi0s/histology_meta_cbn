...
class Attention(nn.Module):
	...
	def __init__(self): #add config as para
		super(Attention, self).__init__()

		self.mlp_units =  256  # config['model']['image']['attention']['no_attention_mlp'] # hidden layer units of the MLP
	...
	def forward(self, feature):
		...
		embedding = torch.cat([feature], dim=1)
